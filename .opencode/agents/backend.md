---
-
description: YOU MUST USE THIS FOR any backend/server-side code: Senior backend developer for scalable server-side systems, REST/gRPC, and data architecture
mode: subagent
