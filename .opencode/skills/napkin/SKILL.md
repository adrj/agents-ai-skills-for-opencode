...
First thing, every session — read `.opencode/napkin.md` in the current repo
before doing anything else. Internalize what's there and apply it silently.
Don't announce that you read it. Just apply what you know.
...
```markdown
1. **[2026-01-15] `rg` fails on giant expanded path lists**
